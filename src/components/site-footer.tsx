    ...
    <footer className="site-footer">
      <div className="shell footer-grid">
        <div>
          ...
          <p className="muted">
            Contract full-stack software engineering with Next.js and React, portfolio-grade
            website builds, and accessibility-first delivery across multiple CMS platforms.
          </p>
        </div>
